clear; close all;
%% settings
folder = 'DIV2K-aug';  % 291 augment dataset
% savepath = 'train_hdf5/train_div2k1_x3.h5';  % save filename
size_input = 29; %11 |% 29 | 39
size_label = 57; %31 |% 57 | 77
scale = 2; % upsacling factorcount
stride = size_input; % subimages sampling stride

%% initialization
for t = 1 : 8
savepath = ['train_hdf5/train_div2k_',num2str(t), '_x',num2str(scale),'.h5'];
